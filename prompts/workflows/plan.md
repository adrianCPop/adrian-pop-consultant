...
- **TRACK-FINDINGS [CRITICAL]**: Read `mrW-AI/findings.md` first. Write after discoveries.
...
Read all shared context files and `mrW-AI/mrw-plans.yml` for existing plans.
...
Write: `mrW-AI/tasks/backlog.md`, individual `mrW-AI/tasks/MRW-NNN.md` files,
