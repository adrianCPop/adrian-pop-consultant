...
- **FINDINGS [CRITICAL]**: Read `mrW-AI/findings.md` first. Write root cause and lesson after.
- **DECISIONS [HIGH]**: If the fix requires a design choice, record in `mrW-AI/shared/decisions.md`.
...
Update `mrW-AI/findings.md`: bug, root cause, fix, test, lesson.
Update `mrW-AI/shared/decisions.md` if design choices were made.
