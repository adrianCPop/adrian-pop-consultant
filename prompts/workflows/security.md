...
- **FINDINGS-INTEGRATION [HIGH]**: Write critical and high severity findings to `mrW-AI/findings.md`.
...
Read `mrW-AI/shared/constraints.md`, `mrW-AI/findings.md`, `mrW-AI/shared/decisions.md` if they exist.
...
Also:
- Append CRITICAL and HIGH findings to `mrW-AI/findings.md` under "## Critical (Read First)"
- Record security-related decisions in `mrW-AI/shared/decisions.md`
