...
Optionally specify `--task MRW-XXX` to build a specific task.
...
- **DECISIONS-LOG [HIGH]**: Non-obvious choices go in `mrW-AI/shared/decisions.md` with context, rationale, and consequences.
- **FINDINGS [CRITICAL]**: Read `mrW-AI/findings.md` before starting. Write after discoveries.
- **CONSTRAINTS [CRITICAL]**: Follow all rules in `mrW-AI/shared/constraints.md`.

## Phase 0: resolve-task

Parse arguments for `--task MRW-XXX`, `--jira PROJ-123`, and `--no-jira`.
...
4. **Record the resume.** Append a note to `mrW-AI/shared/decisions.md`:
   `Resumed partially-built task MRW-XXX; prior work from [claude|codex] retained N passing tests.`
...
Read: `mrW-AI/shared/constraints.md`, `mrW-AI/shared/decisions.md`, `mrW-AI/shared/glossary.md`,
`mrW-AI/findings.md`, `mrW-AI/tasks/current.md`.
...
If you made non-obvious choices, append to `mrW-AI/shared/decisions.md`.
