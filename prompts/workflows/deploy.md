...
- **FINDINGS [CRITICAL]**: Read `mrW-AI/findings.md` before starting. Write infrastructure decisions and deployment outcomes after.
...
Update shared context: append infrastructure decisions to `mrW-AI/shared/decisions.md`, update `mrW-AI/findings.md`, update `mrW-AI/shared/constraints.md` with new deployment constraints.
