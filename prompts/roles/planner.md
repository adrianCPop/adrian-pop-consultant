...
- Read `mrW-AI/shared/constraints.md` — project-wide rules and standards
- Read `mrW-AI/shared/decisions.md` — prior architectural decisions
- Read `mrW-AI/shared/glossary.md` — domain terminology
- Read `mrW-AI/findings.md` — past learnings and mistakes to avoid
...
Per-task costs:
  MRW-001 (S): Builder 20,000 + Reviewer 15,000 + overhead 2,000 = 37,000
  MRW-002 (M): Builder 40,000 + Reviewer 15,000 + overhead 2,000 = 57,000
  MRW-003 (S): Builder 20,000 + Reviewer 15,000 + overhead 2,000 = 37,000
  ...
...
2. Individual task files in `mrW-AI/tasks/MRW-NNN.md` with YAML frontmatter
