              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-4 mt-12">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border bg-background/50 hover:bg-background/70 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                  >
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-lg font-medium transition-all duration-300 ${
                          page === currentPage
                            ...
                            : 'bg-background/50 hover:bg-background/70 border border-border text-muted-foreground hover:text-foreground'
                        }`}
                      >
                        {page}
                      </button>
